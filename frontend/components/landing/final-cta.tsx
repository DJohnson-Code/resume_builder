      ...
      <div className="mx-auto max-w-[min(1380px,94vw)] px-6">
        <Reveal variant="scale">
          <div className="panel-strong relative overflow-hidden rounded-[28px] px-8 py-16 md:px-16 md:py-24">
            <div
              aria-hidden
              className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_top_right,oklch(0.82_0.04_80/0.38),transparent_60%)]"
            />
            <div
              aria-hidden
              className="pointer-events-none absolute inset-x-0 bottom-0 -z-10 h-40 bg-[linear-gradient(180deg,transparent,oklch(0.965_0.004_85/0.7))]"
            />
            ...
            <h2 className="mt-6 max-w-[18ch] font-display text-[clamp(2.4rem,6vw,5rem)] leading-[0.96] tracking-[-0.018em] text-foreground">
              Ship a cleaner resume this afternoon.
            </h2>
            <p className="mt-6 max-w-xl text-[15px] leading-[1.7] text-muted-foreground">
              Bring your current resume or start from a structured template.
              Kerning does the rest — validation, review, export — quietly, in
              one flow.
            </p>
            ...
            <div className="mt-10 flex flex-wrap items-center gap-3">
              ...
              <span className="meta ml-2">NO CARD · FREE WHILE IN BETA</span>
            </div>
          </div>
        </Reveal>
      </div>
